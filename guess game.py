...
greeting = "Well {}, I'm thinking of a number of 1 to 1000." .format(name)
print(greeting)
...
comp_num = random.randint(1, 1000) #this is the computer's random guess
#print(comp_num)  #this can be uncommented while checking to make sure the code works

#you will stay in this while loop as long as your i(# of guesses) isn't above 5
while i < 5:
    people_num = input("Take a guess: ") #player takes their guess
    i = i+1 #adds 1 to the i after every player guess
    if people_num.isdigit() and int(people_num) <=1000 and int(people_num) > 0: #checks to make sure the guess is within 1-1000 and not a letter
